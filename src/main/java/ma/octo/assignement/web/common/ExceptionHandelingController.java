...
public class ExceptionHandelingController {
    ...
    public ResponseEntity<String> handleTransactiontException(Exception ex, WebRequest request) {
        return new ResponseEntity<>("Transaction non réussie", null, HttpStatus.UNAUTHORIZED);
    }
}
